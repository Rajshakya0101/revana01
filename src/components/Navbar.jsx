...
export default function Navbar() {
  ...
  return (
    <>
    <nav>
      <nav className={`fixed top-0 z-50 w-full px-32 py-1 pt-2 flex justify-between items-center bg-white transition-shadow duration-300 ${hasShadow ? "shadow-on-scroll" : ""}`}>
        ...
        <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          <li className={`text-sm ${
              isActive("/") ? "text-[#4f46e5] font-bold" : "text-gray-400 hover:text-gray-500"
            }`}>
            <Link to="/">
              Home
            </Link>
          ...
          <li className={`text-sm ${
              isActive("/about") ? "text-[#4f46e5] font-bold" : "text-gray-400 hover:text-gray-500"
            }`}>
            <Link to="/about">
              About Us
            </Link>
          ...
          <li className={`text-sm ${
              isActive("/services") ? "text-[#4f46e5] font-bold" : "text-gray-400 hover:text-gray-500"
            }`}>
            <Link to="/services">
              Services
            </Link>
          ...
          <li className={`text-sm ${
              isActive("/contact") ? "text-[#4f46e5] font-bold" : "text-gray-400 hover:text-gray-500"
            }`}>
            <Link to="/contact">
              Contact
            </Link>
